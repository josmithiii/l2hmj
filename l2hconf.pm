...
# $DVIPSOPT .= " -E";
#
# NOTE: This option is added automatically by configure (see ./config/config.pl)
...
# $DVIPSOPT .= " -Ppdf";
#
# Note: -Ppdf pulls in alt-rule.pro which may result in black rules under equations.
# Use with caution.
...
#
#jos: $HTML_VERSION = '3.2';  # really old by now
# $HTML_VERSION = '4.0,math'; # Has a problem: "mathend000#" not removed
$HTML_VERSION = '4.0'; # seems to be ok

# -no_math
# Note that the special MATH extensions do not conform with the HTML 3.2 standard.
#
#jos: $NO_SIMPLE_MATH = 1;
$NO_SIMPLE_MATH = 0;


# MathJax support
# Set to 1 to use MathJax for rendering math instead of images.
# This makes equations copy-paste friendly for LLMs and improves accessibility.
#
$USE_MATHJAX = 1;
...
# so that custom macros in your LaTeX documents will be rendered correctly.
# Default macros for \isdef, \isdefs, \eqsp, etc. are built-in.
# Example:
#   %MATHJAX_MACROS = (
#       'mycommand' => '\\frac{1}{2}',
#       'RR'        => '\\mathbb{R}',
...
# ~30 KB macro block.  Requires $USE_MATHJAX = 1.
$MATHJAX_EXTERNAL_CONFIG = 1;
